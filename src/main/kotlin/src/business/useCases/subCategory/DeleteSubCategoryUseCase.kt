...
@Component
class DeleteSubCategoryUseCase(private val subCategoryRepository: ISubCategoryRepository) {
    fun exec(id: Int): Boolean {
        this.subCategoryRepository.findById(id) ?: throw NotFound("Sub Category Not Found")
